...
```
## 1.2 Analyzing the sales by location and year (facet_wrap)
...
```
### Split Location (City & State) and Calcuate Total Price 
```{r}
...
## Innovation in Tech : Top 10 companies worldwide 
```{r}
